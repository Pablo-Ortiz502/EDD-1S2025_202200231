...
procedure TForm17.mailEditChange(Sender: TObject);
begin
    if Form17.mailEdit.Text <> '' then
       Form17.addButton.Enabled := True
    else
      Form17.addButton.Enabled:=False;
end;
...
var
  us: User;
begin
   if logUser.user =  Form17.mailEdit.Text then
    begin
     ShowMessage('No se permite Elimninarse a si mismo');
     Form17.mailEdit.Text:='';
     Exit;
    end;

    us := Form1.userList.findUser(Form17.mailEdit.Text);
